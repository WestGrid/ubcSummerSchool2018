...
- *Bioinformatics session* by Eric Chuah (slides at http://bit.ly/2tS1Mta), Kane Tse (slides at
  http://bit.ly/2tRLiBg), and Nina Thiessen (slides at http://bit.ly/2tS5nHH)
...
- *Introduction to cloud computing* by Scalar and Cycle Computing: slides at http://bit.ly/2rE7VFL and
  http://bit.ly/2rDETX6
...
- *Introduction to Jupyter notebooks and scientific computing in Python* by Patrick Walls: Jupyter
  notebook at https://github.com/patrickwalls/arc-summer-school
- *Data Science at Scale with Hadoop, Spark and The Data Science Experience* by Matt McInnis: slides at
  http://bit.ly/2rUDCuI, Jupyter Notebooks at https://github.com/MattyMc/spark-assets
